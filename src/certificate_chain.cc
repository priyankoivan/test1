	...
	)
{
	...
	command (
		String::compose (
			...
			" -set_serial %3 -in leaf.csr -extfile leaf.cnf -extensions v3_ca -out leaf.signed.pem",
			quoted_openssl, validity_in_days - 2,leaf_serial_number
			)
		);
